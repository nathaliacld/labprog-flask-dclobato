import uuid
from sqlalchemy import ForeignKey, Uuid, String, DECIMAL, Integer, Boolean, Text
...
class Produto(db.Model, BasicRepositoryMixin, TimeStampMixin):
    ...
    foto_mine = mapped_column(String(64), nullable=True, default=None)
    categoria_id = mapped_column(Uuid(as_uuid=True), ForeignKey('categoria.id'))
